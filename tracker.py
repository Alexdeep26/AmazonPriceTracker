...
class AmazonAPI:
    ...
    def run(self):
        ...
        if not links:
            ...
            return
        print(f"Got {len(links)} links to products found")
    ...
    def get_single_product_info(self,asin):
        ...
        self.driver.get(f'{product_short_url}?language=en_CA')
        time.sleep(2)
...
if __name__ == '__main__':
    ...
    data = amazon.run()
    GenerateReport("Gaming Laptop",FILTERS,BASE_URL,CURRENCY,data)